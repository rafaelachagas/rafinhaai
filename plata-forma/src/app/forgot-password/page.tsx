            ...
            <div className="w-full max-w-md relative z-10">
                <div className={`rounded-[2.5rem] p-8 md:p-10 shadow-xl md:shadow-2xl border md:transition-all md:duration-500 ${isDark && mounted
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className={`block w-full pl-11 pr-4 py-3.5 border rounded-2xl leading-5 transition-all focus:outline-none focus:ring-2 focus:ring-[#6C5DD3]/40 focus:border-[#6C5DD3]/40 ${isDark
                    ...
                    <div className="text-center">
                        <Link
                            href="/login"
                            className={`inline-flex items-center text-sm font-medium transition-colors hover:underline ${isDark ? 'text-gray-400 hover:text-[#6C5DD3]' : 'text-gray-600 hover:text-[#6C5DD3]'
                                }`}
                        >
