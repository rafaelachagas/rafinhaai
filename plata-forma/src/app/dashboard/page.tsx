        ...
        <div className="min-h-screen bg-[#F7F8FA] text-[#1B1D21] font-sans flex">
            ...
            <main className="flex-1 p-4 lg:p-8 flex flex-col gap-8 max-w-[1200px] mx-auto">
                ...
                <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <ProgressCard label="Vídeos Assistidos" value="2/8" category="IA Master" color="bg-[#6C5DD3]" />
                    <ProgressCard label="Créditos IA" value="340/500" category="Rafinha.AI" color="bg-[#FF754C]" />
                    <ProgressCard label="Exercícios" value="6/12" category="Treinamento" color="bg-[#3F8CFF]" />
                </section>
                ...
                <section className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        />
                        <VideoCard
                            title="Análise de Métricas no Dashboard"
                            mentor="Ana Paula"
                ...
                <section className="bg-white rounded-[2.5rem] border border-gray-100 p-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <LessonRow mentor="Zakir Horizontal" date="15/02/2026" type="Marketing" desc="Copywriting para anúncios de alta conversão" />
                        <LessonRow mentor="Leonardo Samsul" date="14/02/2026" type="Vendas" desc="Fechamento psicológico com leads frios" />
                    </div>
                </section>
            </main>
            ...
            <aside className="w-80 bg-white border-l border-gray-100 hidden xl:flex flex-col p-8 h-screen sticky top-0 overflow-y-auto">
                ...
                <div className="flex items-center gap-4 mb-10 self-end">
                    <div className="text-right">
                        <p className="font-bold text-sm text-[#1B1D21]">{profile?.full_name || 'Usuário'}</p>
                ...
                <div className="space-y-10">
                    <div>
                        ...
                        <div className="flex flex-col items-center py-6 bg-gray-50 rounded-[2rem] border border-dashed border-gray-200">
                            ...
                            <p className="font-bold text-sm">Bom dia, {profile?.full_name?.split(' ')[0] || 'Aluno'}! 🔥</p>
